// import profilePic from "../assets/Tatoo.PNG"
import profilePic from "../assets/Fist.avif"
        ...
        <div className="pb-4 lg:mb-36 ">
            <div className="flex flex-wrap lg:flex-row-reverse">
                ...
                <motion.div initial="hidden" animate="visible" variants={containerVariants} className="flex flex-col items-center lg:items-start mt-10">
                    <motion.h2 variants={containerVariants} className="pb-2 text-4xl tracking-tighter lg:text-8xl">Jaya Kumar</motion.h2>
                    <motion.span
